     ...
     <form id="form2" name="form2" method="post" action="delete">
	    <table width="1000" border="1" cellspacing="0" cellpadding="0" style="border:1 px; border-collapse:collapse">
	        <tr>
	        	...
	        	<td width="800">crabPicture</td>
	            <td width="200">crabName</td>
	            <td width="200">crabSubject</td>
	            <td width="400">crabFeature</td>
	            <td width="400">crabHabits</td>
	            <td width="400">crabGPS</td>
	        </tr>
		    <c:forEach items="${allCrabinfo}" var="p">
		       <tr>
		        <td><input type="radio" name="check_radio" id="check_radio" value="${p.crab_ID}" /></td>
		        <td><img src="/resources/pic/${p.crab_Picture}" width="100%" alt=""/></td>
		        ...
		        <td><c:out value="${p.crab_GPSLocation}"/></td>
		      </tr>
		    </c:forEach>
	    </table>
	    <br>
